...
<footer>
    <div class="container">
            ...
            <div class="col-md-4 col-sm-4">
                <div class="fwidget">
                    ...
                    <div class="address">
                        ...
                        <p><i class="fa fa-envelope color contact-icon"></i> <a href="mailto:aviadpinto89@gmail.com">aviadpinto89@gmail.com</a></p>
                    </div>
        ...
        <div class="copy text-center">
            Copyright <?= date('Y') ?> &copy; DOGSHOP | Made by <a href="https://www.facebook.com/aviadp" target="_blank">Aviad Pinto</a>.
        </div>
    </div>
</footer>
<!-- Footer ends -->